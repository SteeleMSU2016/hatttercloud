...
/**
 * Created by Jason Steele on 11/1/2015.
 */
public class Cloud {

    private static final String MAGIC = "NechAtHa6RuzeR8x";
    private static final String USER = "steele41";
    private static final String PASSWORD = "Steelie666";
    private static final String CATALOG_URL = "http://webdev.cse.msu.edu/~steele41/cse476/step6/hatter-cat.php";
    private static final String SAVE_URL = "http://webdev.cse.msu.edu/~steele41/cse476/step6/hatter-save.php";
    private static final String DELETE_URL = "http://webdev.cse.msu.edu/~steele41/cse476/step6/hatter-delete.php";
    private static final String LOAD_URL = "http://webdev.cse.msu.edu/~steele41/cse476/step6/hatter-load.php";
...
*/
    ...
    public static class CatalogAdapter extends BaseAdapter {
        ...
        public String getId(int position) {return items.get(position).name;}
